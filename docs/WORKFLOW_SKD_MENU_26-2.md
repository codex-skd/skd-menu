...
> Este archivo pertenece al proyecto **SKD Menu**. Cambios aquí solo afectan a este proyecto.
...
| Última versión publicada | `1.2.4` (CurseForge file ID 8685643) |
| Estado | ✅ Release estable 1.2.4 — fix de compatibilidad con NeoForge 26.2.0.57 (`ModListScreen` movido a `client.gui.modlist`) |
